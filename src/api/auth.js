import {instance as axios, instance_binary} from './axios';
...
export const convertFromBinary = async (number) => instance_binary.get(`/binary/${number}`);
export const convertFromDecimal = async (number) => instance_binary.get(`/decimal/${number}`);
export const convertFromOctal = async (number) => instance_binary.get(`/octal/${number}`);
export const convertFromHexadecimal = async (number) => instance_binary.get(`/hexadecimal/${number}`);
